...
namespace INFT2051app {
    public class Pet : Image{
        ...
        public enum PetState {Alive, Dead}//Dead or alive
        ...
        private void SetImageProperties() {
            //Image properties
            if (Base.EvolvesInto == null && Base.EvolvesFrom != null) {//FINAL
                AbsoluteLayout.SetLayoutBounds(this, new Rectangle(0.5, 0.8, 0.5, 0.5));
            } else if ((Base.EvolvesFrom == null && Base.EvolvesInto != null) || Base.Name.Equals("Robbit")) {//BASIC
                AbsoluteLayout.SetLayoutBounds(this, new Rectangle(0.5, 0.8, 0.2, 0.2));
            } else {//MIDDLE
                AbsoluteLayout.SetLayoutBounds(this, new Rectangle(0.5, 0.8, 0.35, 0.35));
            }
        ...
        public void EvolvePet() {
            if (Base.Name.Equals("Robbit")) {
                 ...
                 * 
                 */
                ChangePet(PetList.FindRandomBasicPet().Name, IsShiny);
            } else if (Base.EvolvesInto != null) {
                ChangePet(Base.EvolvesInto, IsShiny);
            }
        }
        ...
        public async void BounceHigh() {
            if (PetStateValue == PetState.Alive) {
        ...
        private void UpdatePetState() {
            if (Health <= 0) {
                PetStateValue = PetState.Dead;
                AbsoluteLayout.SetLayoutBounds(this, new Rectangle(0.5, 0.8, 0.2, 0.2));
                Source = "Pet_Dead.png";//FOR BEING DEAD
            } else {
                PetStateValue = PetState.Alive;
            }
        }
